...
"""
    reply_markup = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton('Support Group', url='https://t.me/mr_X_Botz'),
                InlineKeyboardButton('Developer', url='https://t.me/Viperclouds_OwNeR')
            ],
            [
                InlineKeyboardButton('Bots Updates Channel', url='https://t.me/mr_X_Botz'),
            ]
        ]
    )
